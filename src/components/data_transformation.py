...
from src.exception import CoustomExceptionm
from src.logger import logging

@dataclass
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join("Artifacts","preprocessor.pk1") # pickle file formation 
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info(
                f"Apllying preprocessing object on training data frame and testing dataframe."
            )
